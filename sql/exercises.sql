...
from
	payment
where
	payment_date between '2005-05-27 00:00:00' and '2005-05-27 23:59:59';
...
select
	* from customer
where
	last_name like 'S%' and first_name like '%N';
...
select
	* from category
where
	category_id > 4 and name like 'C%' or name like 'S%' or name like 'T%';
...
from
	film
where
	special_features in('Behind the Scenes') < 120 and rental_duration between 5 and 7
order by
	length DESC
limit
	10;
